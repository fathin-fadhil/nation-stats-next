...
import { ClientNationsDropdown } from "~/components/client-nations-dropdown";
import { NationSearchLoadingUI } from "~/components/nations-dropdown";
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <footer className="flex w-full shrink-0 flex-col items-center gap-2 border-t bg-white px-4 py-6 sm:flex-row md:px-6">
        <p className="text-xs text-gray-500 dark:text-gray-400">
          © 2024 NationsStat. All rights reserved.
        </p>
